...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <div class="col "><?php foreach ($device as $d) : ?>
                <form class="user mx-2" method="post" action="<?= base_url('engineer/edit_device/') . $d['id']; ?>">
                    ...
                    <div class="modal-footer">
                        <a class="btn btn-secondary" type="button" href="<?= base_url('engineer') ?>">Back</a>
