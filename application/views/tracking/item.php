...
<div class="container-fluid">
    ...
    <div class="col-lg mx-2 mt-3">
        <form action="<?= base_url('tracking/item'); ?>" method="post">
            <div class="form-group row">
                <div class="col-4">
                    <input type="text" name="codewo" class="form-control form-control-user" placeholder="Scan QR Code Item">
                </div>
                <div class="col-4">
    ...
    <?php if ($tracking) { ?>
        ...
        <body className='snippet-body'>
            <div class="container">
                <article class="card">
                    <header class="card-header"> Tracking Item </header>
                    <div class="card-body">
                        <?php foreach ($warehouse as $w) : ?>
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                <tr>
                                    <th>
                                        <div class="col"> <strong>ID: </strong> <br><?= $w['code']; ?> </div>
                                    </th>
                                    <th>
                        ...
                        <div class="track">
                            <?php foreach ($tracking as $t) : ?>
                                <?php foreach ($warehouse as $w) :
                                    $date = date('Y M d H:i:s', strtotime($w['date_created']));
                                ?>
