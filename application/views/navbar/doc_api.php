<!-- Begin Page Content -->
<h2 class="mx-4">NOTE : Ubah "localhost" dengan "103.9.22.227"</h2>
...
<table class="table">
    ...
    <tbody>
        <tr>
            <th scope="row">1</th>
            <td>http://localhost/server/api/mestakung</td>
        ...
        <tr>
            ...
            <th scope="row">2</th>
            <td>http://localhost/server/api/mestakung/realtime</td>
        ...
        <tr>
            ...
            <th scope="row">3</th>
            <td>http://localhost/server/api/mestakung/w</td>
        ...
        <tr>
            <th scope="row">4</th>
            <td>http://localhost/server/api/mesta</td>
        ...
        <tr>
            <th scope="row">5</th>
            <td>http://localhost/server/api/mesta/v</td>
