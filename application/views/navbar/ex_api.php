<!-- /.container-fluid -->
<p class="text-dark mx-3">Semua URL dibawah ini dapat anda akses dengan menggunakan API KEY (dapat dilihat pada <a href="<?= base_url('home/profile'); ?>">My Profile</a>). Data-data yang anda inginkan akan dikirim dalam bentuk JSON. </p>
<div class="mx-3">
    <h3><span class="badge bg-secondary text-light" id="mestakung">http://localhost/server/api/mestakung</span></h3>
    <div class="col-lg-6">
    </div>
    <!-- Basic Card GET -->
...
<div class="mx-3">
    <h3><span class="badge bg-secondary text-light" id="mestakungrealtime">http://localhost/server/api/mestakung/realtime</span></h3>
    <div class="col-lg-6">
    </div>
    <!-- Basic Card GET -->
    <div class="card shadow mb-4">
...
<div class="mx-3">
    <h3><span class="badge bg-secondary text-light" id="mestakungw">http://localhost/server/api/mestakung/w</span></h3>
    <div class="col-lg-6">
    </div>
    <!-- Basic Card GET -->
    <div class="card shadow mb-4">
...
<div class="mx-3 mt-5">
    <h3><span class="badge bg-secondary text-light" id="mesta">http://localhost/server/api/mesta</span></h3>
...
<!-- end of card  -->
<div class="mx-3">
    <h3><span class="badge bg-secondary text-light" id="mestav">http://localhost/server/api/mesta/v</span></h3>
    <div class="col-lg-6">
    </div>
    <!-- Basic Card GET -->
    <div class="card shadow mb-4">
